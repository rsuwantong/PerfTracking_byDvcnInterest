...
drop table if exists meas_ana.techname_bytpid_meas_auto;
create table meas_ana.techname_bytpid_meas_auto row format delimited fields terminated by '\t' as (
select tapad_id, 
